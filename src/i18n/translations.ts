export const resources = {
  ...
  nl: {
    translation: {
      ...
      "The walnut wood card tray is precision milled to perfectly fit a stack of Focus cards. The powder coated steel divider separates active cards from new ones, or can be used to archive important task lists.":
        "De walnoothouten kaartlade is nauwkeurig gefreesd om perfect te passen bij een stapel Focus-kaarten. De met poeder gecoate stalen verdeler scheidt actieve kaarten van nieuwe, of kan worden gebruikt om belangrijke takenlijsten te archiveren.",
      Material: "Materiaal",
      ...
      "Upload your image,<br /> get the perfect <br /> print delivered.": "Upload uw afbeelding,<br /> krijg de perfecte afdruk geleverd.",
      ...
      "Our professional designers ensure every image, even horizontal ones, is perfectly tailored to fit your frame. We'll send you the final design for your approval, giving you the last say.":
        "Onze professionele ontwerpers zorgen ervoor dat elke afbeelding, zelfs horizontale, perfect op maat wordt gemaakt voor uw lijst. We sturen u het definitieve ontwerp ter goedkeuring, zodat u het laatste woord heeft.",
      ...
      "Turn your photos and designs into stunning, high-quality custom art prints that elevate any space. Whether you’re looking for personalized wall art, custom posters, or framed prints, we deliver exceptional results across the Netherlands, Germany, and all of Europe.":
        "Verander uw foto's en ontwerpen in prachtige, hoogwaardige aangepaste kunstafdrukken die elke ruimte verheffen. Of u nu op zoek bent naar gepersonaliseerde wandkunst, aangepaste posters of ingelijste afdrukken, wij leveren uitzonderlijke resultaten in heel Nederland, Duitsland en heel Europa.",
      ...
      "From personal photos to unique artwork, our custom art prints are crafted with care, ensuring vibrant colors and long-lasting quality. Perfect for European homes, our prints bring your vision to life.":
        "Van persoonlijke foto's tot unieke kunstwerken, onze aangepaste kunstafdrukken zijn met zorg vervaardigd, met levendige kleuren en een langdurige kwaliteit. Perfect voor Europese huizen, onze afdrukken brengen uw visie tot leven.",
      ...
      "Choose from a variety of elegant poster frames, sizes, and mats to create a custom framed print that fits your style. Each print is delivered ready to hang, making it easy to transform your space.":
        "Kies uit een verscheidenheid aan elegante posterlijsten, maten en passe-partouts om een aangepaste ingelijste afdruk te maken die bij uw stijl past. Elke afdruk wordt geleverd klaar om op te hangen, waardoor het gemakkelijk is om uw ruimte te transformeren.",
      ...
      "Simply upload your design or photo, and we’ll handle the rest. Our expert team ensures that your high-quality custom poster is printed and framed to perfection, with fast shipping guaranteed.":
        "Upload eenvoudig uw ontwerp of foto, en wij regelen de rest. Ons deskundige team zorgt ervoor dat uw hoogwaardige aangepaste poster perfect wordt afgedrukt en ingelijst, met gegarandeerde snelle verzending.",
      "From Amsterdam to Berlin, our European poster printing service ensures that your custom art prints and personalized gifts are delivered with Dutch quality and reliability. Order today and experience the difference!":
        "Van Amsterdam tot Berlijn, onze Europese posterprintservice zorgt ervoor dat uw aangepaste kunstafdrukken en gepersonaliseerde geschenken worden geleverd met Nederlandse kwaliteit en betrouwbaarheid. Bestel vandaag en ervaar het verschil!",
      ...
      "Welcome to PrintMeArt, your premier destination for high-quality prints, custom posters, and art prints. Whether you want to enhance your home with stunning art posters from our catalog, or showcase your creativity by uploading and printing your own designs, we’ve got everything you need.":
        "Welkom bij PrintMeArt, uw toonaangevende bestemming voor hoogwaardige afdrukken, op maat gemaakte posters, en kunstafdrukken. Of u nu uw huis wilt verfraaien met onze prachtige kunstposters uit de catalogus, of uw creativiteit wilt tonen door uw eigen ontwerpen te uploaden en te printen, wij hebben alles wat u nodig hebt.",
      ...
      "Have a unique vision? Easily upload your own designs, photos, or artwork, and we’ll transform them into beautiful prints. Perfect for personalizing your space or creating unique personalized gifts in the Netherlands.":
        "Heb je een unieke visie? Upload eenvoudig je eigen ontwerpen, foto's of kunstwerken, en wij transformeren ze in prachtige afdrukken. Perfect voor het personaliseren van je ruimte of het creëren van unieke gepersonaliseerde cadeaus in Nederland.",
      "Our prints are made using the finest materials, ensuring vibrant colors and sharp details. Whether you’re decorating your home or surprising a loved one, our high-quality posters are designed to impress.":
        "Onze afdrukken worden gemaakt met de beste materialen, waardoor levendige kleuren en scherpe details gegarandeerd zijn. Of u nu uw huis decoreert of een geliefde verrast, onze hoogwaardige posters zijn ontworpen om te imponeren.",
      ...
      "Complete your artwork with our stylish framing options, available in various sizes and finishes. Our frames are designed to complement your prints, making them ready to hang and adding elegance to any room.":
        "Voltooi uw kunstwerk met onze stijlvolle inlijstopties, beschikbaar in verschillende formaten en afwerkingen. Onze lijsten zijn ontworpen om uw afdrukken te complementeren, waardoor ze klaar zijn om op te hangen en elegantie toevoegen aan elke kamer.",
    },
  },
};
