...
import clientSayMain from "../../data/images/clientSayMain.png";
import clientSay1 from "../../data/images/clientSay1.png";
import clientSay2 from "../../data/images/clientSay2.png";
import clientSay3 from "../../data/images/clientSay3.png";
import clientSay4 from "../../data/images/clientSay4.png";
import clientSay5 from "../../data/images/clientSay5.png";
import clientSay6 from "../../data/images/clientSay6.png";
import quotationImg from "../../data/images/quotation.png";
import quotationImg2 from "../../data/images/quotation2.png";
...
const SectionClientSay: FC<SectionClientSayProps> = ({ className = "" }) => {
  ...
  return (
    ...
    >
      <Heading desc={t("Let's see what people think of PrintMe Art")} isCenter>
        {t("Good news from far away")}🥇
      </Heading>
