...
const ProductDetailPage = ({}) => {
  ...
  const notifyAddTocart = () => {
    ...
    cartItem.pictureUrl = product.imageThumbnail;
            ...
            <div className="flex items-center justify-between space-x-5">
              ...
              <a href="#reviews" className="flex items-center text-sm font-medium">
                ...
                <span className="ml-1.5 flex">
                  ...
                  <span className="text-slate-700 dark:text-slate-400 underline">{0} reviews</span>
                </span>
              </a>
            </div>
  ...
  const renderSection1 = useCallback(() => {
    return (
      <div className="listingSection__wrap !space-y-6">
        ...
        <AccordionInfo
          data={[
            { name: "Title", content: product.title ?? "" },
  ...
  }, [status, product?.name, product.title, product.description, 0, calculatedPrice]);
