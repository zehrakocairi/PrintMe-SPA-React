  ...
  return (
    <div className={`nc-PageLogin`} data-nc-id="PageLogin">
      <Helmet>
        ...
        <link rel="canonical" href={`${window.location.origin}/login?lang=${i18n.language}`} />
      </Helmet>
        ...
        <div className="max-w-md mx-auto space-y-6">
          <div className="grid gap-3">
            {loginSocials?.map((item, index) => (
              <a onClick={item.handleClick} key={index} href={item.href} className="flex w-full rounded-lg bg-primary-50 dark:bg-neutral-800 px-4 py-3 transform transition-transform sm:px-6 hover:translate-y-[-2px]">
