  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row items-center relative text-center lg:text-left space-y-6 lg:space-y-0 lg:space-x-10">
      <div className="w-full lg:w-1/2 space-y-3 lg:space-y-4">
        <span className="inline-block bg-purple-100 text-purple-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-purple-900 dark:text-purple-300">Our Frames</span>
        ...
        Explore our wide range of frames to find the perfect match for your paintings and photos. Our high-quality framing options ensure durability and style, enhancing the presentation of your artwork. Select from various styles and finishes to suit your preferences and decor.
        </span>
