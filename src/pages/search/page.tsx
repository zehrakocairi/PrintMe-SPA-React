        ...
        <header className="max-w-2xl mx-auto -mt-10 flex flex-col lg:-mt-7">
          <div className="relative w-full ">
            <label htmlFor="search-input" className="text-neutral-500 dark:text-neutral-300">
              ...
              <Input className="shadow-lg border-0 dark:border" id="search-input" type="search" placeholder={t("Type your keywords")} sizeClass="pl-14 py-5 pr-5 md:pl-16" rounded="rounded-full" value={searchText} onChange={(e) => setSearchText(e.target.value)} />
              <ButtonCircle className="absolute right-2.5 top-1/2 transform -translate-y-1/2" size=" w-11 h-11" onClick={search} type="button">
