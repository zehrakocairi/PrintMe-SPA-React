...
const CheckoutPage = () => {
  ...
  const renderProduct = (item: CartItem, index: number) => {
    let { pictureUrl, unitPrice, quantity, productName, productId } = item;
    let size = 0,
      frameId = 1,
    ...
    return (
      <div key={index} className="relative flex py-7 first:pt-0 last:pb-0">
        <div className="relative h-36 w-24 sm:w-28 flex-shrink-0 overflow-hidden rounded-xl bg-slate-100">
          <Image src={pictureUrl} fill alt={productName} className="h-full w-full object-contain object-center" sizes="150px" />
            ...
            <div className="flex justify-between ">
              <div className="flex-[1.5] ">
                ...
                <div className="mt-3 flex justify-between w-full sm:hidden relative">
                  <Prices contentClass="py-1 px-2 md:py-1.5 md:px-2.5 text-sm font-medium h-full" hideFromLabel={true} price={unitPrice * quantity} />
                </div>
              </div>
  ...
  return (
    <div className="nc-CheckoutPage">
      <main className="container py-16 lg:pb-28 lg:pt-20 ">
        <div className="mb-16">
          <h2 className="block text-2xl sm:text-3xl lg:text-4xl font-semibold ">{t("Check out")}</h2>
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-[36%] ">
            ...
            <div className="mt-10 pt-6 text-sm text-slate-500 dark:text-slate-400 border-t border-slate-200/70 dark:border-slate-700 ">
              <div>
                ...
                <div className="flex mt-1.5">
                  ...
                  <button className="text-neutral-700 dark:text-neutral-200 border border-neutral-200 dark:border-neutral-700 hover:bg-neutral-100 rounded-2xl px-4 ml-3 font-medium text-sm bg-neutral-200/70 dark:bg-neutral-700 dark:hover:bg-neutral-800 w-24 flex justify-center items-center transition-colors">{t("Apply")}</button>
                </div>
              </div>
              ...
              <div className="flex justify-between py-2.5">
                ...
                <span className="font-semibold text-slate-900 dark:text-slate-200">€{taxTotal}</span>
              </div>
            ...
            <ButtonPrimary disabled className="mt-8 w-full">
              {t("Confirm order")}
            </ButtonPrimary>
